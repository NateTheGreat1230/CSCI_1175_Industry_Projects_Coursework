...
public class AddNewRowDemo extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        flowPane.getChildren().addAll(new Label("Country: "), tfCountry, new Label("Capital"), tfCapital, new Label("Population"), tfPopulation, chkDemocratic, btAddRow);
        ...
        flowPane.getChildren().add(btDelRow);
